...
public class Fenetre extends JFrame implements Observer{
	...
	//public Fenetre(Observable obs){ modif "Suppression du passage en paramètre d'un objet du type Observable"  
	//public Fenetre(Model model){ modif "Suppression du passage en paramètre d'un objet du type Observable"
	/*
		    ...
		    //this.model = obs; modif "Suppression du passage en paramètre d'un objet du type Observable"
		    //this.model.addObserver(this); modif "Suppression du passage en paramètre d'un objet du type Observable"
		    this.model1 = model;
		    ...
		    nouveau.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent arg0){
					...
					//model.addObserver(gp); modif "Suppression du passage en paramètre d'un objet du type Observable"
	    ...
	    score.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0){
				...
				conteneur.revalidate();
				//model.reset(); modif "Suppression du passage en paramètre d'un objet du type Observable"
				model1.reset();
			}
	    });
...
*/
	  public Fenetre(){
	    ...
	    this.model.addObserver(this); modif "Suppression du passage en paramètre d'un objet du type Observable" */
	    //this.model1 = model;
	    //this.model1.addObserver(this); A supprimer si on ne fait pas la ligne au dessus (Null pointer Exception)
	    this.size = new Dimension(this.getWidth(), this.getHeight());
	...
	*/
	...
	private void initModel(){
		/*this.model = new Model(); modif "Suppression du passage en paramètre d'un objet du type Observable"
